...
export class ShoppingListService {
    ...
    addIngredient(ingredient: Ingredient) {
        ...
        this.ingredientsChanged.emit(this.ingredients.slice()); // emit the ingredients array
    }

    addIngredients(ingredients: Ingredient[]) {
        this.ingredients.push(...ingredients); // add the new ingredients to the ingredients array by using the spread operator
        this.ingredientsChanged.emit(this.ingredients.slice()); // emit the ingredients array copy
    }
}